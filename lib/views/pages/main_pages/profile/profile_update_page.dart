                                                                ...
                                                                builder: (
                                                                  ...
                                                                  return TextButton(
                                                                    onPressed: () {
                                                                      employer
                                                                          .update(
                                                                          orgName: _controllers[1]
                                                                              .text,
                                                                          name: _controllers[0]
                                                                              .text,
                                                                          email: _controllers[2]
                                                                              .text,
                                                                          legalAddress: _controllers[3]
                                                                              .text,
                                                                          actualAddress: _controllers[4]
                                                                              .text,
                                                                          companyDescription: _controllers[5]
                                                                              .text,
                                                                          post: _controllers[6]
                                                                              .text
                                                                      );
