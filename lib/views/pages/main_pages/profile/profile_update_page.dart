                                      ...
                                      child: BlocListener<ProfileUpdateBloc, ProfileUpdateState>(
                                        ...
                                        child: ProfileUpdateForm(
                                            ...
                                            onConfirm: (context, formValue) {
                                              employer.update(
                                                  orgName: employerUpdateModel.orgName,
                                                  name: employerUpdateModel.name,
                                                  email: employerUpdateModel.email, legalAddress: employerUpdateModel.legalAddress, actualAddress: employerUpdateModel.actualAddress, companyDescription: employerUpdateModel.companyDescription, post: employerUpdateModel.post);
